...
function main() {
  ...
  if (args.length === 0) {
    ...
    console.log('\nCategories:');
    console.log('  defi, dao, infrastructure, tokens, gaming, social, rwa, privacy, developer, analytics, wallet, insurance, art, supplychain, healthcare, finance');
    console.log('\nTypes by Category:');
    ...
    console.log('\nExamples:');
    console.log('  node metadata-generator.js --category defi --type amm --name Uniswap --version 3');
    console.log('  node metadata-generator.js --category dao --type governor --dao ENS --token ENS');
    console.log('  node metadata-generator.js --category tokens --type erc20 --symbol UNI --supply 1000000000');
    console.log('\nOptions:');
  ...
  try {
    ...
    console.log(`  ens-contract register ${type}.${options.name || 'protocol'}.${category}.eth --type ${type}`);
    console.log(`  ens-contract metadata ${type}.${options.name || 'protocol'}.${category}.eth --data metadata.json`);
    console.log('');
    console.log(`  # Set cross-references:`);
    console.log(`  ens-contract metadata ${type}.${options.name || 'protocol'}.${category}.eth --set protocol.factory=factory.${options.name || 'protocol'}.${category}.eth`);
